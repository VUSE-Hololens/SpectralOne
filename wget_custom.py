# wget_custom
# wget but slightly customized to application
...
def filename_fix_existing(filename):
    ...
    """
    dirname = u'.'
    print("wget_custom debug. filename={0}".format(filename))
...
def download(url, filename, out=None, bar=bar_adaptive):
    ...
    :param filename: name of file within directory
